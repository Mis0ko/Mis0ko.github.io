---
title:  "Attaque de l'active Directory & NTDS.dit"
...
Avant de voir l'attaque, rappelons le processus d'authentification une fois qu'un système Windows a rejoint un domaine afin de mieux comprendre l'intérêt de l'active directory dans cette attaque.
...
```
Dans l'exemple précédent, on essaye de se connecter en tant qu'utilisateur **-u jDoe** avec la liste de mots de passes **usr/share/wordlists/fasttrack.txt**.
...
<img src="/assets/images/htbAcademy/eventLogPanel.png" alt="Alt text" width="1000" height="550">
...
Une fois connecté, on peut voir quel privilège possède l'utilisateur de la session **(bwilliamson)** ici.
...
## Cracker les Hashes et Obtenir les Credentials
...
L'attaque **Pth** profite du **protocole d'authentification NTLM**, qui permet d'authentifier un utilisateur à partir d'un hash plutôt qu'un mot de passe en clair. On peut ainsi opérer de la sorte avec **Evil-WinRM.**
